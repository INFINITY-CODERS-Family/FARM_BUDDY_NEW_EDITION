      ...
      <Container style={{ backgroundImage: `url("https://cdn.pixabay.com/photo/2016/03/27/07/32/clouds-1282314_960_720.jpg")`, height: "100%", backgroundRepeat: "no-repeat", backgroundSize: "cover" }} maxWidth={false}>
        ...
        <Box style={{ padding: 80 }}>
          ...
          <div id="Helpline Numbers">
            ...
            <Typography variant='subtitle1' sx={{ fontSize: "18px", }} className='contentb'>The Government of India has various helpline numbers for the Agriculture department which farmers can use to get information and assistance related to agricultural activities in the country.</Typography>
            <Typography variant='subtitle1' sx={{ fontSize: "18px" }} className='contentb'>Some of the helpline numbers are:</Typography>
            ...
            <Typography variant='subtitle1' mt={2} marginBottom={4} sx={{ fontSize: "18px" }} className='contentb'>* Please note that the helpline numbers may change in future, and I recommend double checking with the official websites for the most up-to-date information. </Typography>
          </div >
        </Box>
      </Container>
    </>
